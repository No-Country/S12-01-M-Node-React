  ...
  return (
    <nav className="mt-10 w-full flex justify-center items-center">
            <ul className="h-fit w-2/3 flex flex-col justify-center items-center">
                <li className={`border-b-[#B3B3B3] border-b-[1px] w-full p-3 ${pathname === '/ayuda#QaQuestions' ? 'text-Principal' : 'text-[#4E4E4E] '}`}>
                    <Link href="/ayuda#QaQuestions" className={`w-full cursor-pointer ${pathname === '/ayuda#QaQuestions' ? 'text-Principal' : 'text-[#4E4E4E] '} `}>Preguntas frecuentes</Link>
                </li>
