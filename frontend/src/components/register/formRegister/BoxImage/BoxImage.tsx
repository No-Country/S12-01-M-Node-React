      ...
      <div>
        <div className="relative">
          <Image
            ...
            height={500}
            objectFit="cover"
            className="w-[750px] h-[644px]"
          />
          <span className="absolute top-0 w-min-[300px] md:w-[750px] h-full bg-gradient-to-t from-[#BE316C] via-[#F006B0] to-[#F006B0] opacity-30"></span>
        </div>
      </div>
